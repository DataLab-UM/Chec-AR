      ...
      //         if (canplayWebm == "") {
      //           document.querySelector("#paintandquest-video-link").setAttribute("src", "#gol-mp4");
      ...
      const showInfo = () => {
        ...
        text.addEventListener('click', function (evt) {
          // Aquí se puede agregar funcionalidad si es necesario, o eliminar si no es necesario
        });
      }
      ...
      const showPortfolio = (done) => {
        ...
        const id = setInterval(() => {
          ...
          if (y >= 0.6) {
            ...
            // Si no se necesitan los botones de navegación, eliminar esta sección
            // portfolioLeftButton.setAttribute("visible", true);
            // portfolioRightButton.setAttribute("visible", true);
